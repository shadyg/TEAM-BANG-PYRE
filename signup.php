    ...
    <div class="container aside-xl">
      ...
      <section class="m-b-lg">
        ...
        <form action="index.php">
          ...
          <div class="form-group">
             <input type="date" placeholder="Birthday" class="form-control rounded input-lg text-center no-border">
          </div>
              <div class="form-group">
             <input type="" placeholder="Description" class="form-control rounded input-lg text-center no-border">
          </div>
          <div class="form-group">
          ...
          <button type="submit" class="btn btn-lg btn-danger lt b-2x btn-block btn-rounded"><i class="icon-arrow-right pull-right"></i><span class="m-r-n-lg">Sign up</span></button>
          <div class="line line-dashed"></div>
          <p class="text-muted text-center"><small>Already have an account?</small></p>
          <a href="signin.php" class="btn btn-lg btn-default btn-block btn-rounded text-danger-dk">Sign in</a>
        </form>
      </section>
    </div>
  </section>
