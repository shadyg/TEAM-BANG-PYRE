...
<body>
  ...
  <section id="content" class="wrapper-xl animated fadeInUp">    
    ...
    <div class="container aside-xl">
      <a class="navbar-brand block" href="index.php"><span class="h1 font-bold">PYRE</span></a>
      <section class="m-b-lg">
        ...
        <form action="index.php">
          ...
          <button type="submit" class="btn btn-lg btn-danger lt b-2x btn-block btn-rounded"><i class="icon-arrow-right pull-right"></i>
            <span class="m-r-n-lg">Sign in</span></button>
          <!--<div class="text-center m-t m-b"><a href="#"><small>Forgot password?</small></a></div>-->
          <div class="line line-dashed"></div>
          <p class="text-white text-center"><small><b>Do not have an account?</b></small></p>
          <a href="signup.php" class="btn btn-lg btn-default btn-block rounded text-danger dk">Create an account</a>
        </form>
      </section>
