                ...
                <div class="col-sm-offset-1 col-sm-10">
                  <div class="panel bg-black lt">
                    ...
                    <div id="jp_container_1">
                      <div class="jp-type-single pos-rlt">
                        ...
                        <div class="jp-gui">
                          ...
                          <div class="jp-interface bg-black dk padder">
                            <div class="jp-controls bg-black dk">
                              <div>
                    ...
                    <div class="wrapper-lg">
                      <h2 class="m-t-none text-white">PYRE Trailer</h2>
                      <div class="post-sum text-white">
                        <p>Binaural Beat madness. 
                        <br><br>
                        Get ready for a big surprise.</p>
                      </div>
